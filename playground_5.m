...
%TSdiag
 ...
 sf3 = sf1;
    for j = 1:numel(Pf1)
        sf1(j) = XR410a('s','Ph', Pf1(j), hf1(j) ); 
        sf2(j) = XR410a('s','Ph', Pf2(j), hf2(j) ); 
        sf3(j) = XR410a('s','Ph', Pf3(j), hf3(j) ); 
    end
plotcycle_TS( Tf1, sf1, 'T_env',T_amb,T_pod,'cyclecolor','r','stationlabels')
hold on
plotcycle_TS( Tf2, sf2, 'T_env',T_amb,T_pod,'cyclecolor','g')
hold on
plotcycle_TS( Tf3, sf3, 'cyclecolor','b')
